...
\shorttitle{Reproducible research report}
...
\abstract{The culmination of research is the research report. Ergo, the
  culmination of reproducible research is the reproducible
...
\item [\mintinline{bash}{make si} (4 s)] Run \mintinline{bash}{pdflatex author_si.tex}
